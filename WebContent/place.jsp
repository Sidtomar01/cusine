...
try{
    ...
    PreparedStatement pst = con1.prepareStatement("Select * from sign where name=? ");
  ...
  ResultSet rs = pst.executeQuery();                        
    if(rs.next())
    {
		...
		%><label>Your Order will  be dilivred to the location  entered:::</label> <%out.println(rs.getString(4));
		...
		}catch(Exception e)
{
		...
		<br><center><h3>or</h3></center><br>
		
		<label for="address" >Enter the address you want your order to be delivered </label><br>
		<textarea  placeholder ="new address enter!!" class="inp"></textarea><br>
...
<center><a href="index.jsp"><button>OK</button></a>
