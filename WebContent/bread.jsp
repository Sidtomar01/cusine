...
<h2> <div class="w3-center w3-padding-16" style="color:red;">FROM BREADS</div> </h2>
    <div class="w3-quarter">
      <img src="breads/kulcha.jpg" alt="Sandwich" style="width:100%">
      <h3 name="aamdal" >Kulcha</h3>
   
      
      
      <p value="100">RS 20 </p><a href="Cart.jsp?id=17"><img src="cart.png" style="width:10% ; height:10%"/></a>
    </div>
    <div class="w3-quarter">
      <img src="breads/lacchaparatha.jpg" alt="Steak" style="width:100%">
      <h3 name="butter paneer">Laccha Paratha</h3>
      <p value="140">RS 15 </p><a href="Cart.jsp?id=18"><img src="cart.png" style="width:10% ; height:10%"/></a>
    </div>
    <div class="w3-quarter">
      <img src="breads/naan.jpg" alt="Cherries" style="width:100%">
      <h3 name=coyat>Naan</h3>
      <p value="160">RS 50</p><a href="Cart.jsp?id=19"><img src="cart.png" style="width:10% ; height:10%"/></a>
      
    </div>
    <div class="w3-quarter">
      <img src="breads/roti.jpg" alt="Pasta and Wine" style="width:100%">
      <h3 name="matar paneer" >Roti</h3>
      <p value="120">RS 15</p><a href="Cart.jsp?id=20"><img src="cart.png" style="width:10% ; height:10%"/></a>
    </div>
  </div>
