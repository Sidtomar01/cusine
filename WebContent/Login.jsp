...
<div class="info"> Login Here!!!</div>
<form action="InsertServelet1" method="post" class="form-box">
...
<input type="submit" value="check" class="sub-btn"/><br>
...
<a href="Signup.jsp"><label>New User</label></a>
